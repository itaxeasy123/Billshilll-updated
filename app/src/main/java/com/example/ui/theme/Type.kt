...
// Phase UI-02: the full Material 3 baseline type scale, made explicit. Every value here is
// byte-identical to Compose Material3's own built-in default for that style name (bodyLarge was
// already defined this way before this phase; every other style was previously an *implicit*
// default - reading MaterialTheme.typography.titleLarge etc. already worked, it just had no named
// definition anywhere in this codebase to point at). Naming these explicitly is what "one
// centralized design system for... font sizes/weights/line heights" requires - it changes zero
// pixels on any existing screen, since every value matches what was already being rendered.
val Typography =
  Typography(
